    ...
    justify-content: center; ">
            <form action="comu_modify2.php/<?php echo $row['num'];?>" method="POST">
                ...
                <table class="table table-striped" style="border: 1px solid #ddddda">
                    ...
                    <tbody>
                        <tr>
                            <td><span class="pull-left" style="width: 400px; text-align:left; margin-left:0px">&nbsp;&nbsp;&nbsp;이름 :<b><?php echo  $row['name'];?></b></span>
                            </td>
                        </tr>
                        <tr>
                            <td><input type="text" style="width: 400px;" class="form-control" placeholder="글 제목" name="title" id="utitle"
